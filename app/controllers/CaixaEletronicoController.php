...
class CaixaEletronicoController {
    ...
    public function __construct(ICaixaEletronicoModel $caixaEletronicoModel, ICaixaEletronicoDao $caixaEletronicoDao, Logger $logger) {
    ...
    public function saqueCaixaEletronicoAction($valor) {
        ...
        try {
            ...
            Notification::add('Saque no valor de R$ ' . number_format($valor, 2) . ' realizado com sucesso.', 'success');
